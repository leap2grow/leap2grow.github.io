...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/tags/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Nick Saraev">
    <meta property="og:url" content="https://leap2grow.github.io/tags/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Nick Saraev">
    <meta name="twitter:url" content="https://leap2grow.github.io/tags/">
...
> 
  ...
  <section class="px-4 sm:px-6">
    <div class="max-w-2xl mx-auto py-16 flex flex-col gap-4 md:gap-6 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl sm:text-3xl md:text-5xl lg:text-5xl">Tags</h1>
    </div>
  </section>

  <section class="px-4 sm:px-6 mb-24" data-tags>
    <div class="max-w-container mx-auto">    
      <h2 class="text-sm font-semibold uppercase text-typ-tone border-b border-brd mb-6 pb-2.5">
        11 Topics 
      </h2>

      <ul class="grid gap-6 grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
          <li class=""  data-tag-card>
  <a href="/tag/msc/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Miscellaneous</h3>
    <p class="text-typogr-tone text-sm">
      23 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/ftr/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Futurology</h3>
    <p class="text-typogr-tone text-sm">
      20 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/lfimpr/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Life Improvement</h3>
    <p class="text-typogr-tone text-sm">
      16 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/building-in-public/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Building in Public</h3>
    <p class="text-typogr-tone text-sm">
      6 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/agencystrategy/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Agency Strategy</h3>
    <p class="text-typogr-tone text-sm">
      6 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/cusp/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">The Cusp Newsletter</h3>
    <p class="text-typogr-tone text-sm">
      6 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/ai-use-cases/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">AI use cases</h3>
    <p class="text-typogr-tone text-sm">
      4 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/artificial-intelligence/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">artificial intelligence</h3>
    <p class="text-typogr-tone text-sm">
      3 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/programming/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Programming</h3>
    <p class="text-typogr-tone text-sm">
      2 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/youtube/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">YouTube</h3>
    <p class="text-typogr-tone text-sm">
      2 posts
    </p>
  </a>
</li>          <li class=""  data-tag-card>
  <a href="/tag/pinned/" class="w-full h-full flex flex-col gap-2 rounded-theme-xs bg-bgr border border-brd p-4 lg:p-5 hover:bg-bgr-tone">
    <h3 class="text-base md:text-lg font-medium flex-1">Popular Products</h3>
    <p class="text-typogr-tone text-sm">
      No posts
    </p>
  </a>
