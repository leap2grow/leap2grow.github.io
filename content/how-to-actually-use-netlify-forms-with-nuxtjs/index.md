...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>How to Actually Use Netlify Forms with NuxtJS</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="article">
    <meta property="og:title" content="How to Actually Use Netlify Forms with NuxtJS">
    <meta property="og:description" content="Netlify Forms are a simple, easy way to set up forms on your statically
generated websites. Historically, though, projects that use NuxtJS have had
difficulty implementing Netlify Forms because of how Netlify crawls NuxtJS code.
This guide shows you how to use Netlify Forms and NuxtJS effectively.

How to use">
    <meta property="og:url" content="https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/">
    <meta property="og:image" content="https://leap2grow.github.io/content/images/size/w1200/2022/03/302.png">
    <meta property="article:published_time" content="2021-02-05T00:00:00.000Z">
    <meta property="article:modified_time" content="2022-03-12T21:50:36.000Z">
    ...
    <meta name="twitter:title" content="How to Actually Use Netlify Forms with NuxtJS">
    <meta name="twitter:description" content="Netlify Forms are a simple, easy way to set up forms on your statically
generated websites. Historically, though, projects that use NuxtJS have had
difficulty implementing Netlify Forms because of how Netlify crawls NuxtJS code.
This guide shows you how to use Netlify Forms and NuxtJS effectively.

How to use">
    <meta name="twitter:url" content="https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/">
    <meta name="twitter:image" content="https://leap2grow.github.io/content/images/size/w1200/2022/03/302.png">
    ...
    <script type="application/ld+json">
{
    ...
    "headline": "How to Actually Use Netlify Forms with NuxtJS",
    "url": "https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/",
    "datePublished": "2021-02-05T00:00:00.000Z",
    "dateModified": "2022-03-12T21:50:36.000Z",
    "image": {
        "@type": "ImageObject",
        "url": "https://leap2grow.github.io/content/images/size/w1200/2022/03/302.png",
        "width": 1200,
        "height": 600
    },
    "keywords": "Programming",
    "description": "Netlify Forms are a simple, easy way to set up forms on your statically\ngenerated websites. Historically, though, projects that use NuxtJS have had\ndifficulty implementing Netlify Forms because of how Netlify crawls NuxtJS code.\nThis guide shows you how to use Netlify Forms and NuxtJS effectively.\n\nHow to use Netlify Forms with NuxtJS\nIn the Netlify Forms docs [https://docs.netlify.com/forms/setup/], they tell you\nthat all you need to do is include a hidden data-netlify&#x3D;&quot;true&quot; attribute to\nyour ",
    "mainEntityOfPage": "https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/"
}
    </script>
...
.gh-post-upgrade-cta a.gh-btn:hover {
    ...
    <script defer src="/public/ghost-stats.min.js?v=0e088e74f9" data-stringify-payload="false" data-datasource="analytics_events" data-storage="localStorage" data-host="https://leap2grow.github.io/.ghost/analytics/api/v1/page_hit"  tb_site_uuid="1ae3de90-cafc-423f-b6a1-36af422be674" tb_post_uuid="bbebc104-c9a0-441e-9a39-9d01072c77ba" tb_post_type="post" tb_member_uuid="undefined" tb_member_status="undefined"></script><style>:root {--ghost-accent-color: #008cff;}</style>
    <script type="application/ld+json">
{
...
> 
  ...
  />
      ...
      <figure class="max-w-content w-full h-full relative">
        <picture  >
  <source 
    srcset="/content/images/size/w320/format/webp/2022/03/302.png 320w, /content/images/size/w640/format/webp/2022/03/302.png 600w, /content/images/size/w960/format/webp/2022/03/302.png 960w, /content/images/size/w1280/format/webp/2022/03/302.png 1200w"
  ...
  />
    ...
    <article class="ghost-content prose md:prose-lg prose-theme">
      <p>Netlify Forms are a simple, easy way to set up forms on your statically generated websites. Historically, though, projects that use NuxtJS have had difficulty implementing Netlify Forms because of how Netlify crawls NuxtJS code. This guide shows you how to use Netlify Forms and NuxtJS effectively.</p><h2 id="how-to-use-netlify-forms-with-nuxtjs"><strong>How to use Netlify Forms with NuxtJS</strong></h2><p>In the <a href="https://docs.netlify.com/forms/setup/?ref=nicksaraev.com" rel="nofollow noopener noreferrer">Netlify Forms docs</a>, they tell you that all you need to do is include a hidden <code>data-netlify="true"</code> attribute to your main form, and then you're good to go.</p><p>However, <strong>as of February 2021</strong>, NuxtJS and Netlify Forms can lead to weird, unexpected behavior—like your forms not submitting when you change pages, or your form submitting, but being completely empty.</p><p>After a few hours of research, I figured out the issue and learned how to fix it. In order to get Netlify Forms to work, we simply need to add a few extra lines of code.</p><h3 id="add-a-hidden-input-field-under-your-form-element">Add a hidden input field under your form element</h3><p>For clarity's sake, let's say this is the example form that we want to connect to Netlify:</p><pre><code class="language-html">&lt;form name="contact" method="POST"&gt;
...
&lt;/form&gt;
</code></pre><p>In order to get this form to work, you need to add a <strong>hidden input element under your form element</strong>. That input element needs to have two things: a <code>value</code> attribute that is the same as the <code>name</code> attribute of its parent form, and a <code>name</code> attribute that is equal to <code>form-name</code>.</p><p>Confused? Here's what your HTML would look like after adding the hidden input field:</p><pre><code class="language-html">&lt;form name="contact" data-netlify="true" method="POST"&gt;
...
&lt;/form&gt;
</code></pre><p>If you're keen, you'll notice that our hidden input field is marked up slightly differently than the first name, last name, and submit inputs that we had previously—it has the closing tag <code>/&gt;</code> unlike the regular input tag <code>&gt;</code>. This is purposeful. For whatever reason, Netlify's crawlers prefer this markup. Make sure your hidden field includes that as well.</p><h3 id="include-a-honeypot-attribute">Include a honeypot attribute</h3><p>In order to further increase the likelihood of Netlify's crawlers finding our form, we'll add one final attribute: the <code>data-netlify-honeypot</code> attribute. Modify your form so that it looks like this:</p><pre><code class="language-html">&lt;form name="contact" data-netlify="true" data-netlify-honeypot="bot-field" method="POST"&gt;
...
&lt;/form&gt;
</code></pre><p>This magical configuration was at the end of approximately five hours of brutal bug-fixing. My Netlify forms submitted fine on my <strong>NextJS</strong> projects, but for some reason they weren't submitting on my NuxtJS projects, which prompted the research.</p><p>I sincerely hope you enjoyed this short guide on <strong>how to actually use Netlify Forms with NuxtJS</strong>! Happy programming.</p>
    </article>
    ...
    <div class="pt-8 text-typ text-sm font-medium max-w-content mx-auto flex gap-3 md:gap-4 justify-center flex-wrap items-center relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[1px] before:bg-fading" 
      ...
      <a class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" target="_blank"
          href="https://twitter.com/share?text=How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS&amp;url=https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/"
  ...
  <path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"></path>
      ...
      <a class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" target="_blank"
          href="https://bsky.app/intent/compose?text=How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS%20https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/"
  ...
  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-bluesky"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6.335 5.144c-1.654 -1.199 -4.335 -2.127 -4.335 .826c0 .59 .35 4.953 .556 5.661c.713 2.463 3.13 2.75 5.444 2.369c-4.045 .665 -4.889 3.208 -2.667 5.41c1.03 1.018 1.913 1.59 2.667 1.59c2 0 3.134 -2.769 3.5 -3.5c.333 -.667 .5 -1.167 .5 -1.5c0 .333 .167 .833 .5 1.5c.366 .731 1.5 3.5 3.5 3.5c.754 0 1.637 -.571 2.667 -1.59c2.222 -2.203 1.378 -4.746 -2.667 -5.41c2.314 .38 4.73 .094 5.444 -2.369c.206 -.708 .556 -5.072 .556 -5.661c0 -2.953 -2.68 -2.025 -4.335 -.826c-2.293 1.662 -4.76 5.048 -5.665 6.856c-.905 -1.808 -3.372 -5.194 -5.665 -6.856z" /></svg>
      ...
      <a class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" target="_blank"
          href="https://www.facebook.com/sharer.php?u=https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/"
  ...
  <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" />
      ...
      <a class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" target="_blank"
          href="https://www.linkedin.com/shareArticle?mini=true&url=https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/&title=How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS&summary=How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS"
  ...
  <circle cx="4" cy="4" r="2"></circle>
      ...
      <a class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" data-share-mail
          href="mailto:?subject=How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS&body=https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/&nbsp;How%20to%20Actually%20Use%20Netlify%20Forms%20with%20NuxtJS"
  ...
  <polyline points="3 7 12 13 21 7" />
      ...
      <button class="border border-brd bg-bgr leading-tight p-1.5 px-3 flex-1 flex gap-1.5 items-center justify-center rounded-theme hover:bg-bgr-tone" data-share-copy data-url="https://leap2grow.github.io/how-to-actually-use-netlify-forms-with-nuxtjs/"
  ...
  <path d="M13 18l-.397 .534a5.068 5.068 0 0 1 -7.127 0a4.972 4.972 0 0 1 0 -7.071l.524 -.463"></path>
    ...
    <a href="/how-to-use-tailwind-typography-with-nuxtjs/" class="block">
      <figure class="rounded-theme-xxs border border-brd overflow-hidden">
        <picture  >
  <source 
    srcset="/content/images/size/w320/format/webp/2022/03/301.png 320w, /content/images/size/w640/format/webp/2022/03/301.png 600w, /content/images/size/w960/format/webp/2022/03/301.png 960w"
  ...
  <div class="flex h-full flex-col gap-2" data-post-card-content>
    ...
    <h3 class="text-typ text-lg sm:text-xl font-semibold hover:text-brand " data-post-card-title>
      <a href="/how-to-use-tailwind-typography-with-nuxtjs/" class="">How to Use Tailwind Typography with NuxtJS</a>
    </h3>

      <p class="font-light" data-post-card-excerpt>
        NuxtJS is a modern web development platform that makes it easy to build fast,
statically generated websites and applications. With
      </p>
