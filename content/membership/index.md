...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/membership/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Nick Saraev">
    <meta property="og:url" content="https://leap2grow.github.io/membership/">
    ...
    <meta name="twitter:url" content="https://leap2grow.github.io/membership/">
...
> 
  ...
  <section class="px-4 sm:px-6">
    <div class="max-w-2xl mx-auto py-16 flex flex-col gap-4 md:gap-6 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl sm:text-3xl md:text-5xl lg:text-5xl">Membership</h1>
    </div>
  </section>

<section class="px-4 sm:px-6" data-plan="yearly" data-plans="free,monthly,yearly" data-member-status="none"
  x-init="$nextTick(() => { calculateDiscounts() })"
>
    

    <div class="max-w-[48rem] mx-auto grid justify-center gap-6 grid-cols-[repeat(auto-fill,minmax(calc(16rem_+_2vw),1fr))]" data-tiers-count="1">
      <button class="mb-4 relative text-sm font-medium flex p-1 text-typ-tone border border-brd rounded-theme-xl justify-self-center col-span-full before:content-[''] before:absolute before:w-[calc(50%_-_4px)] before:h-[calc(100%_-_8px)] before:rounded-theme before:bg-bgr-tone before:z-[-1] before:border before:border-brd before:transition-transform" 
        ...
        <span data-plan="monthly" class="min-w-32 flex-1 py-2 px-6">Monthly</span>
        <span data-plan="yearly" class="min-w-32 flex-1 py-2 px-6">Yearly</span>
      </button>

        <article data-tier="free" class="flex flex-col p-6 bg-bgr-tone border border-brd rounded-theme-xs" 
          ...
          <header class="flex flex-col gap-3">
            ...
            <p class="text-sm text-typ-tone">Get my 110-step roadmap to $25,000/month with AI &amp; get updated every time I post.</p>
            
              <span class="text-2xl md:text-3xl">$0</span>
            ...
            <ul class="flex flex-col gap-1 text-sm text-typ-tone pt-6 mt-6 relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[1px] before:bg-fading" data-tier-benefits>
                <li class="flex gap-1.5 items-center"><i class="icon icon-check size-4 text-accent stroke-2">
  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  <path d="M5 12l5 5l10 -10"></path>
</svg>
</i>Learn how AI &amp; automation make me over $100,000/month.</li>
                <li class="flex gap-1.5 items-center"><i class="icon icon-check size-4 text-accent stroke-2">
  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  <path d="M5 12l5 5l10 -10"></path>
</svg>
</i>Get access to all of my Make.com &amp; no-code blueprints.</li>
                <li class="flex gap-1.5 items-center"><i class="icon icon-check size-4 text-accent stroke-2">
  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  <path d="M5 12l5 5l10 -10"></path>
</svg>
</i>Unsubscribe anytime if you don&#x27;t get immediate value.</li>
            </ul>
          ...
          <span class="flex-1"></span>
            ...
            <a class="mt-6 block text-center shadow-btn border border-b-0 border-opac bg-accent text-sm md:text-base font-medium text-brand-contrast px-4 py-2 rounded-theme-lg md:px-5 md:py-2.5 transition duration-300 hover:brightness-105 hover:shadow-btn-hover" href="/signup/" data-portal="signup">Subscribe now</a>
        </article>
    </div>
