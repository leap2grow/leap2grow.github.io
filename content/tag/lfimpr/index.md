...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>Life Improvement - Nick Saraev</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/tag/lfimpr/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    <link rel="next" href="https://leap2grow.github.io/tag/lfimpr/page/2/">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Life Improvement - Nick Saraev">
    <meta property="og:description" content="Nick Saraev is a writer &amp; entrepreneur who pivoted from a path in medicine to forge a series of successful digital media businesses. He&#x27;s been featured in Popular Mechanics, Apple News, &amp; Bloomberg, and is an Amazon Kindle best-seller.">
    <meta property="og:url" content="https://leap2grow.github.io/tag/lfimpr/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Life Improvement - Nick Saraev">
    <meta name="twitter:description" content="Nick Saraev is a writer &amp; entrepreneur who pivoted from a path in medicine to forge a series of successful digital media businesses. He&#x27;s been featured in Popular Mechanics, Apple News, &amp; Bloomberg, and is an Amazon Kindle best-seller.">
    <meta name="twitter:url" content="https://leap2grow.github.io/tag/lfimpr/">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://leap2grow.github.io/tag/lfimpr/",
    "name": "Life Improvement",
    "mainEntityOfPage": "https://leap2grow.github.io/tag/lfimpr/"
}
    </script>
...
.gh-post-upgrade-cta a.gh-btn:hover {
    ...
    <script defer src="/public/ghost-stats.min.js?v=0e088e74f9" data-stringify-payload="false" data-datasource="analytics_events" data-storage="localStorage" data-host="https://leap2grow.github.io/.ghost/analytics/api/v1/page_hit"  tb_site_uuid="1ae3de90-cafc-423f-b6a1-36af422be674" tb_post_uuid="undefined" tb_post_type="null" tb_member_uuid="undefined" tb_member_status="undefined"></script><style>:root {--ghost-accent-color: #008cff;}</style>
    <script type="application/ld+json">
{
...
<style>
  ...
  <body class="tag-template tag-lfimpr subpixel-antialiased relative overflow-x-hidden bg-bgr text-typ"
  ...
  />
    ...
    <li class="nav-journal-entries nav-current flex relative border border-transparent hover:bg-bgr-tone rounded-theme is-subitem" 
...
> 
  <div class="px-4 sm:px-6">
    ...
    <li class="nav-journal-entries nav-current flex relative is-subitem" 
      data-label="- Journal Entries" data-slug="journal-entries" data-length="17">
  ...
  <section class="px-4 sm:px-6" data-tag>
    <div class="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Life Improvement</h1>
    </div>
  </section>
    ...
    <div class="max-w-container mx-auto">
        ...
        <ul role="list" class="text-sm text-typ-tone font-medium flex gap-1 overflow-x-scroll no-scrollbar border-b border-brd pb-2.5">
          <li>
            ...
            <li>
              <a href="/tag/agencystrategy/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                Agency Strategy
              </a>
            </li>
            <li>
              <a href="/tag/cusp/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                The Cusp Newsletter
              </a>
            </li>
            <li>
              <a href="/tag/ftr/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                Futurology
              </a>
            </li>
            <li>
              <a href="/tag/lfimpr/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                Life Improvement
              </a>
            </li>
            <li>
              <a href="/tag/msc/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                Miscellaneous
              </a>
            </li>
            <li>
              <a href="/tag/building-in-public/" class="relative block text-nowrap px-3 py-1 border border-transparent rounded-theme md:px-4 after:content-[''] after:absolute after:bottom-[-11px] after:left-[calc(50%_-_16px)] after:w-8 after:h-0.5 after:rounded-t-sm after:bg-transparent hover:bg-bgr-tone">
                Building in Public
              </a>
            </li>
        </ul>
...
<section class="px-4 sm:px-6 mb-24" data-feed-section="12">
  ...
  <div class="grid -mt-6" data-post-feed>
      <article class="post tag-lfimpr featured  text-sm text-typ-tone" data-post-card>
  <a href="/next-few-months/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <path d="M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" />
    ...
    <div class="flex gap-2">
        <span class="">Life Improvement</span>
    </div>
...
</article>      <article class="post tag-lfimpr  text-sm text-typ-tone" data-post-card>
  <a href="/lifestyle-audit/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/doing-in-public-minimizing-friction/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/the-postponed-start/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/building-income-stability-and-an-amazing-lifestyle-with-small-projects/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/bad-is-the-prequel-to-the-good/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/low-hanging-performance-optimization/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/the-magic-pill/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/is-self-employment-risky/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/emotion-drives-success/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/default-mode-mindset/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
...
<nav class="flex items-center gap-2 text-typ-tone text-base" data-socials="footer" x-data="socials">
  ...
  <path d="M10 9l5 3l-5 3z" />
    ...
    <li class="nav-journal-entries nav-current flex flex-col relative is-subitem" 
      data-label="- Journal Entries" data-slug="journal-entries" data-length="17">
