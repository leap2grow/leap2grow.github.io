...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>Miscellaneous - Nick Saraev</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/tag/msc/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    <link rel="next" href="https://leap2grow.github.io/tag/msc/page/2/">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Miscellaneous - Nick Saraev">
    ...
    <meta property="og:url" content="https://leap2grow.github.io/tag/msc/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Miscellaneous - Nick Saraev">
    ...
    <meta name="twitter:url" content="https://leap2grow.github.io/tag/msc/">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://leap2grow.github.io/tag/msc/",
    "name": "Miscellaneous",
    "mainEntityOfPage": "https://leap2grow.github.io/tag/msc/"
}
    </script>
...
<style>
  ...
  <body class="tag-template tag-msc subpixel-antialiased relative overflow-x-hidden bg-bgr text-typ"
...
> 
  ...
  <section class="px-4 sm:px-6" data-tag>
    <div class="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Miscellaneous</h1>
    </div>
  </section>
...
<section class="px-4 sm:px-6 mb-24" data-feed-section="12">
...
</article>      <article class="post tag-msc  text-sm text-typ-tone" data-post-card>
  <a href="/how-to-make-your-voice-deeper/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-negotiate-on-craigslist-get-what-you-want-every-time/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/skillshare-worth-it-in-2020/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-negotiate-your-cable-bill-with-comcast-other-providers/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-win-a-fight-by-a-huge-nerd/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-get-rid-of-bruises-ultimate-guide/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-negotiate-with-credit-card-companies/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-get-a-po-box/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-get-into-porn-in-2020/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-long-does-it-take-to-receive-a-masters-degree/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/how-to-get-your-voice-back-a-3-minute-guide/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
