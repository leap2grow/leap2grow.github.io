...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>Building in Public - Nick Saraev</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/tag/building-in-public/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Building in Public - Nick Saraev">
    ...
    <meta property="og:url" content="https://leap2grow.github.io/tag/building-in-public/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Building in Public - Nick Saraev">
    ...
    <meta name="twitter:url" content="https://leap2grow.github.io/tag/building-in-public/">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://leap2grow.github.io/tag/building-in-public/",
    "name": "Building in Public",
    "mainEntityOfPage": "https://leap2grow.github.io/tag/building-in-public/"
}
    </script>
...
<style>
  ...
  <body class="tag-template tag-building-in-public subpixel-antialiased relative overflow-x-hidden bg-bgr text-typ"
...
> 
  ...
  <section class="px-4 sm:px-6" data-tag>
    <div class="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Building in Public</h1>
    </div>
  </section>
...
<section class="px-4 sm:px-6 mb-24" data-feed-section="6">
  ...
  <div class="grid -mt-6" data-post-feed>
      <article class="post tag-building-in-public  text-sm text-typ-tone" data-post-card>
  ...
  <a href="/38-41/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/who-i-am-goals-motivations-companies/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
    ...
    <time class="" datetime="2023-11-27">Nov 27, 2023</time> 
  ...
  <a href="/how-i-learned-photography-in-16-hours/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
