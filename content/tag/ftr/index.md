...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>Futurology - Nick Saraev</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <meta name="description" content="Posts about the future, AI, and how economics are going to change.">
    <link rel="icon" href="https://leap2grow.github.io/content/images/size/w256h256/2024/02/social_media.png" type="image/png">
    <link rel="canonical" href="https://leap2grow.github.io/tag/ftr/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    <link rel="next" href="https://leap2grow.github.io/tag/ftr/page/2/">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Futurology - Nick Saraev">
    <meta property="og:description" content="Posts about the future, AI, and how economics are going to change.">
    <meta property="og:url" content="https://leap2grow.github.io/tag/ftr/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Futurology - Nick Saraev">
    <meta name="twitter:description" content="Posts about the future, AI, and how economics are going to change.">
    <meta name="twitter:url" content="https://leap2grow.github.io/tag/ftr/">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://leap2grow.github.io/tag/ftr/",
    "name": "Futurology",
    "mainEntityOfPage": "https://leap2grow.github.io/tag/ftr/",
    "description": "Posts about the future, AI, and how economics are going to change."
}
    </script>
...
<style>
  ...
  <body class="tag-template tag-ftr subpixel-antialiased relative overflow-x-hidden bg-bgr text-typ"
...
> 
  ...
  <section class="px-4 sm:px-6" data-tag>
    <div class="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Futurology</h1>
        <p class="font-light text-lg text-typ-tone">Posts about the future, AI, and how economics are going to change.</p>
    </div>
  </section>
...
<section class="px-4 sm:px-6 mb-24" data-feed-section="12">
...
</article>      <article class="post tag-ftr  text-sm text-typ-tone" data-post-card>
  <a href="/the-ai-paradox/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/we-really-dont-know-so-lets-stop-pretending-that-we-do/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/artificial-intelligence-call/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/autonomous-artificial-intelligence/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/artificial-intelligence-bomb/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
...
</article>      <article class="post tag-artificial-intelligence tag-ftr  text-sm text-typ-tone" data-post-card>
  <a href="/can-machines-think-and-other-wild-questions-answered/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
...
</article>      <article class="post tag-ai-use-cases tag-ftr  text-sm text-typ-tone" data-post-card>
  <a href="/artificial-intelligence-in-the-workplace/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/dall-e-2-the-death-of-art/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/ai-business-use-cases-the-emerging-ai-icon-industry/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/ai-business-use-cases-icons/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">

    <div class="flex items-center flex-wrap gap-3 col-span-3 lg:col-span-5">
      <h3 class="text-typ md:text-base font-medium " data-post-card-title>
        AI business use cases: the emerging AI icon industry
      </h3>
    ...
    <time class="" datetime="2022-03-25">Mar 25, 2022</time> 
