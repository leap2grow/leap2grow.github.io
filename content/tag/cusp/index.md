...
<html lang="en" data-color-scheme="system" class="scroll-smooth">
  <head>
    ...
    <title>The Cusp Newsletter - Nick Saraev</title>
...
<style> 
  ...
  setBrandHSL("#008cff");
    ...
    <link rel="canonical" href="https://leap2grow.github.io/tag/cusp/">
    <meta name="referrer" content="no-referrer-when-downgrade">
    
    <meta property="og:site_name" content="Nick Saraev">
    <meta property="og:type" content="website">
    <meta property="og:title" content="The Cusp Newsletter - Nick Saraev">
    ...
    <meta property="og:url" content="https://leap2grow.github.io/tag/cusp/">
    <meta property="article:publisher" content="https://www.facebook.com/nick.john.wells">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="The Cusp Newsletter - Nick Saraev">
    ...
    <meta name="twitter:url" content="https://leap2grow.github.io/tag/cusp/">
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://leap2grow.github.io/tag/cusp/",
    "name": "The Cusp Newsletter",
    "mainEntityOfPage": "https://leap2grow.github.io/tag/cusp/"
}
    </script>
...
<style>
  ...
  <body class="tag-template tag-cusp subpixel-antialiased relative overflow-x-hidden bg-bgr text-typ"
...
> 
  ...
  <section class="px-4 sm:px-6" data-tag>
    <div class="max-w-xl mx-auto py-16 md:py-20 flex flex-col gap-3 items-center justify-center text-center">
      <h1 class="font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl">The Cusp Newsletter</h1>
    </div>
  </section>
...
<section class="px-4 sm:px-6 mb-24" data-feed-section="6">
  ...
  <a href="/chatgpt-scores-70-on-a-sample-united-states-medical-licensing-exam/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
    ...
    <div class="flex gap-2">
        <span class="">The Cusp Newsletter</span>
    </div>
...
</article>      <article class="post tag-cusp  text-sm text-typ-tone" data-post-card>
  <a href="/our-knowledge-economy-is-swiftly-coming-to-an-end/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/gpt-3-5-released-content-companies-reeling/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/ai-generated-stock-photos-set-to-dethrone-shutterstock/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/generating-metaverse-environments-in-seconds/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
  ...
  <a href="/ai-animation-is-coming/" class="relative py-4 md:py-6 border-b border-brd grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2 items-center sm:items-start before:content-[''] before:absolute before:-z-[1] before:h-full before:w-[calc(100%_+_32px)] before:-inset-x-4 before:rounded-theme-xxs hover:before:bg-bgr-tone">
